...
<div class="main_body">
    ...
    <div class="room">
        ...
        <h5>東会場</h5>
        <img src="images/map_east.png">
        </div>
        <div class="content-en">
        <h5>East Venue</h5>
        <img src="images/map_east_en.png">
        </div>
    </div>
    <!-- serch
    ================================================== -->
    ...
    <div class="sideangle">
        ...
        <div class="rightangle" id="right"><a href="select_course.php"><i class="fas fa-angle-right fa-3x"></i><p>キャンパス</p></div></a>
    </div>
    </div>
    ...
    <div class="sideangle">
        ...
        <div class="rightangle" id="right"><a href="select_course.php"><i class="fas fa-angle-right fa-3x"></i><p>On Campus</p></div></a>
    </div>
    </div>
